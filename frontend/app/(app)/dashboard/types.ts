...
export type DashboardIssue =
  | { type: 'relaxation_suggestion'; suggestion: Filter_Relaxation_Suggestion };
...
export interface ActionNeededItem {
  ...
  reason: string;
  created_at: string;
  /** Whether an employer contact email exists for direct send. */
  has_employer_email?: boolean;
  /** Job listing URL for external apply flow. */
  source_url?: string;
}
