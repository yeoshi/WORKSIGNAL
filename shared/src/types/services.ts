...
import type { AgentName, CareerStage, PriorityFactor, ResidencyStatus } from './enums.js';
import type {
  AmbitionVerdict,
  MasterDecision,
  OpportunityVerdict,
...
import type { DiscoveredJob, FilterResult, Job } from './job.js';
import type {
  Application,
  Classification,
  MatchResult,
...
import type { Filter_Relaxation_Suggestion } from './relaxation.js';
import type { SkillGapRoadmap, NetworkSuggestionSet } from './growth.js';
import type { RecalibrationLogEntry } from './recalibration.js';
import type {
  InvalidVerdict,
  ParseFailure,
  RankingError,
