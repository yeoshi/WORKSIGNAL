/**
 * Extract a short LinkedIn-style headline: "Software Engineer @ Google".
 */
...
/**
 * Best-effort extraction of a one-line LinkedIn headline from Exa title/text.
 */
...
/**
 * Format a stored context string for display — parses LinkedIn scrape noise when
 * present, otherwise returns a short primary segment.
 */
